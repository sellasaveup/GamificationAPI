...
AND ub.GOAL_CODE='HYPE_GOAL' and ub.GOAL_CODE=b.GOAL_CODE and b.BADGE_CODE=ub.BADGE_CODE order by ub.DATE desc
--getMyLockedBadge
selectb.NAME, b.IMAGE, b.STORY from ss_ma_badge b where b.BADGE_CODE not in (
