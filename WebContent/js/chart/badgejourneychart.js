function drawbadgejourneychart(divId, goalCode){
	$.ajax({
		type : "GET",
		url :  commonUrl + 'GET_BADGE_JOURNEY_CHART?goalCode=' + goalCode,
		dataType : "json",
		...
		success : function(data) {	
			...
			var chartData = [
				...
				new Chart(ctxT).Pie(chartData, {
					animateScale : true
				});
		},
		error : function(e) {
			console.log('badge journey chart call failure : ' + e);
		}
	});
}