function drawleveljourneychart(divId, goalCode){
	$.ajax({
		type : "GET",
		url :  commonUrl + 'GET_LEVEL_JOURNEY_CHART?goalCode=' + goalCode,
		dataType : "json",
		...
		success : function(data) {	
			...
			new Chart(ctxT).Doughnut(chartData, {
				animateScale : true
			});
		},
		error : function(e) {
			console.log('level journey chart call failure : ' + e);
		}
	});
}